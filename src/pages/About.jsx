        ...
        <>
            <section className="wrapper">
                <div className="container | header">
                    <img src='/src/assets/parallex-img.jpg' className='background' />
                    ...
                    <div className="container">
                        <div className="store-card">
                            ...
                            <div className="about-image-description flow-200">
                                <h1 className='font-200 fw-semibold'>How was <span className='fw-bold'>VFASHION</span> Started?</h1>
                    ...
                    <div className="container padding-block-900">
                        ...
                        <div className="journal-columns">
                            <Link className="journal-item no-underline">
                                <div className="image"><img src={journal3} alt="Our Journal Image 1" /></div>
                            ...
                            <Link className="journal-item no-underline">
                                <div className="image"><img src={journal1} alt="Our Journal Image 2" /></div>
                                <div className="journal-text">
                            ...
                            <Link className="journal-item no-underline">
                                <div className="image"><img src={journal2} alt="Our Journal Image 3" /></div>
                                <div className="journal-text">
